...
macro(fetchDiscordGameSDK)
    ...
    file(COPY ${CMAKE_BINARY_DIR}/_deps/discordGameSDK/lib/x86_64/discord_game_sdk.dll ${CMAKE_BINARY_DIR}/_deps/discordGameSDK/lib/x86_64/discord_game_sdk.so DESTINATION ${CMAKE_BINARY_DIR})
    ...
    target_link_libraries(CrossPlatformLibraries INTERFACE DiscordGameSDK)
    target_include_directories(CrossPlatformLibraries INTERFACE ${CMAKE_BINARY_DIR}/_deps/discordGameSDK/c/)
endmacro()
