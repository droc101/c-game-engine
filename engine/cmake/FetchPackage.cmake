...
function(fetch_discord_sdk)
    ...
    if (WIN32)
        ...
        file(COPY_FILE ${CMAKE_BINARY_DIR}/discord_game_sdk.dll ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/discord_game_sdk.dll)
        ...
        file(COPY_FILE ${CMAKE_BINARY_DIR}/discord_game_sdk.so ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/discord_game_sdk.so)
        set_target_properties(discord_game_sdk PROPERTIES IMPORTED_LOCATION "${CMAKE_BINARY_DIR}/discord_game_sdk.so")
    endif ()
